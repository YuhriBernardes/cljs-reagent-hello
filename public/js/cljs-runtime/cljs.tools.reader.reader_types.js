...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_27501 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_27501(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_27508 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_27508(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_27513 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_27513(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_27519 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_27519(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_27527 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_27527(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_27531 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_27531(reader);
}
});
...
var G__27637 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__27638 = s.append(c);
c = G__27637;
s = G__27638;
continue;
}
