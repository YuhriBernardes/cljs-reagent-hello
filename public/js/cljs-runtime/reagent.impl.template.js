...
while (G__28803__i < G__28803__a.length) {G__28803__a[G__28803__i] = arguments[G__28803__i + 0]; ++G__28803__i;}
  args = new cljs.core.IndexedSeq(G__28803__a,0,null);
} 
return G__28800__delegate.call(this,args);};
G__28800.cljs$lang$maxFixedArity = 0;
G__28800.cljs$lang$applyTo = (function (arglist__28804){
var args = cljs.core.seq(arglist__28804);
...
var G__28775 = o;
goog.object.set(G__28775,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__28778 = props;
var G__28778__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__28778,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__28778);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__28778__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__28778__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__28779 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__28779,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__28779;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__28780){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28781__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__28783_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__28783_SHARP_);
}));
} else {
return null;
}
...
var vec__28785 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28785,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28785,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28785,(2),null);
...
var temp__5739__auto___28829 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___28829 == null)){
} else {
var key_28831 = temp__5739__auto___28829;
(jsprops.key = key_28831);
}
...
var temp__5739__auto___28837 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___28837 == null)){
} else {
var key_28838 = temp__5739__auto___28837;
(jsprops.key = key_28838);
}
...
var G__28789 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__28789) : reagent.impl.template.as_element.call(null,G__28789));
} else {
var temp__5739__auto___28843 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___28843 == null)){
} else {
var key_28844 = temp__5739__auto___28843;
(jsprops.key = key_28844);
}
...
var G__28791 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__28791)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__28791)){
return x;
} else {
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq28792){
...
break;
default:
var G__28849 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__28849;
continue;
...
var ctx = ({});
var vec__28796 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28796,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28796,(1),null);
...
var G__28799 = (cljs.core.count(argv) - first_child);
switch (G__28799) {
case (0):
