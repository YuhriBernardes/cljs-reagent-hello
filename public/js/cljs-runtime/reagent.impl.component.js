...
if((i < len)){
var k = (ks[i]);
var G__28765 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__28766 = (i + (1));
m = G__28765;
i = G__28766;
continue;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__28678 = c;
var G__28678__$1 = (((G__28678 == null))?null:G__28678.prototype);
if((G__28678__$1 == null)){
return null;
} else {
return G__28678__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__28682 = c;
var G__28682__$1 = (((G__28682 == null))?null:G__28682.prototype);
if((G__28682__$1 == null)){
return null;
} else {
return G__28682__$1.render;
}
})() == null)))));
});
...
var G__28690 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__28690) : reagent.impl.component.as_element.call(null,G__28690));
};
...
var G__28691 = c;
var G__28691__$1 = (((G__28691 == null))?null:G__28691.constructor);
if((G__28691__$1 == null)){
return null;
} else {
return G__28691__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__28692 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__28693 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__28693);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__28692);
}});
...
var c = this;
var G__28734_28774 = goog.object.get(c,"cljsRatom");
if((G__28734_28774 == null)){
} else {
reagent.ratom.dispose_BANG_(G__28734_28774);
}
...
var renders_28776 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_28777 = cljs.core.first(cljs.core.vals(renders_28776));
...
if((cljs.core.count(renders_28776) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_28776))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_28777)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_28777], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__28764 = o;
goog.object.set(G__28764,cljs.core.name(k),v);
